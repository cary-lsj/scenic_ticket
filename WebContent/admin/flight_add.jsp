...
<link rel="stylesheet" type="text/css" href="/scenic_ticket/admin/asset/css/plugins/animate.min.css"/>
<link rel="stylesheet" type="text/css" href="/scenic_ticket/admin/asset/css/style.css" >
</head>
<body >
<form method="post" action="../url_scenic_add">

    <div class="panel">
		<div class="panel-body">
			<div class="col-md-12">
				<h3 class="animated fadeInLeft">添加景区门票</h3>
				<p class="animated fadeInDown">景区门票管理<span class="fa-angle-right fa"></span>添加景区门票</p>
			</div>
		</div>
    </div>
