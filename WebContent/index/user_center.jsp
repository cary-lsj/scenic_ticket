...
<link type="text/css" rel="stylesheet" href="/scenic_ticket/index/css/icon.css">
	...
	<div class="ydc-content-slide ydc-body" style="height:86%;">
		<div class="ydc-flex" style="height:100%;">
				...
				<div class="ydc-menu">
					<ul>
						<li class="ydc-menu-item"><span class="ydc-menu-sub-title">
							...
							<ul>
								<li><a target="frame" href="/scenic_ticket/index/user_info.jsp"
									class="active">个人资料</a></li>
								<li><a target="frame" href="/scenic_ticket/index/edit_info.jsp">修改信息</a></li>
							</ul></li>
						...
						<li class="ydc-menu-item">
							...
							<ul>
								<li><a target="frame" href="/scenic_ticket/index/order_list.jsp">订单列表</a></li>
							</ul>
						</li>
			...
			<div style="width:76%;height:100%;">
				<iframe name="frame" scrolling="auto" width="100%" height="100%" frameborder="0" src="/scenic_ticket/index/user_info.jsp"></iframe>
			</div>
			<!-- right end -->
		</div>
	</div>
