...
public class upload_file extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) 
		...
		//GET方式提交的数据基本都是非法操作，不用处理，直接返回edit_info页面就可以
			resp.sendRedirect("/scenic_ticket/index/edit_info.jsp");
	}
						...
						if(item!=null) {
							...
							if(filename!=null) {
								...
								try {
									...
									if(res!=0) {
										response.sendRedirect("/scenic_ticket/index/user_info.jsp");
									}else {
										
										out.println("文件上传失败，程序出现bug，请联系开发人员修复bug");
										response.setHeader("refresh", "2;url=/scenic_ticket/index/user_info.jsp");
									}
